const AboutusLogoList = () => {
  return (
    <div className="bg-zinc-50 flex flex-col items-center space-y-6  justify-center md:items-center pb-10 pt-6 gap-6">
      ...
      <div className="flex justify-center flex-col items-center md:gap-48 md:flex-row">
